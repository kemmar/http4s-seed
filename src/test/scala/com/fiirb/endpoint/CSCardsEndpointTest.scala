...
class CSCardsEndpointTest extends CatsEffectSuite with TestHttpClient {

  private val uri = Uri.uri("https://test.com/api/global/backend-tech-test/v1/cards")
  ...
  test("can handle successful requests") {
    ...
    val service = new CSCardsEndpoint[IO](client)
